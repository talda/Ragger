...
class chatEngine:
    def __init__(self, index_name: str, assistant: str = 'general purpose', system_prompt: str = default_system_prompt, use_history: bool = False) -> None:
        self.index_instance = Index(index_name)
        self.context_query = contextGenerator(self.index_instance, assistant)
        self.history = []
